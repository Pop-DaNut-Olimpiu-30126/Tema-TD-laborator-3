var app = new Vue({
  ...
  methods: {
    ...
    encode: function (bits) {
      ...
      var c32 = this.parity(
        parseInt(bits[26].data) + parseInt(bits[27].data) + parseInt(bits[28].data) + 
      ...
      var c16 = this.parity(
        ...
        parseInt(bits[14].data) + parseInt(bits[15].data) + parseInt(bits[16].data) +
        parseInt(bits[17].data) + parseInt(bits[18].data) + parseInt(bits[19].data) +
        parseInt(bits[20].data) + parseInt(bits[21].data) + parseInt(bits[22].data) +
        parseInt(bits[23].data) + parseInt(bits[24].data) + parseInt(bits[25].data)
      );
      ...
      var c8 = this.parity(
        ...
        parseInt(bits[10].data) + parseInt(bits[18].data) + parseInt(bits[19].data) +
        parseInt(bits[20].data) + parseInt(bits[21].data) + parseInt(bits[22].data) +
        parseInt(bits[23].data) + parseInt(bits[24].data) + parseInt(bits[25].data)
      );
      ...
      var c4 = this.parity(
        ...
        parseInt(bits[16].data) + parseInt(bits[17].data) + parseInt(bits[22].data) +
        parseInt(bits[23].data) + parseInt(bits[24].data) + parseInt(bits[25].data) +
        parseInt(bits[29].data) + parseInt(bits[30].data) + parseInt(bits[31].data)
      );
      ...
      var c2 = this.parity(
        ...
        parseInt(bits[16].data) + parseInt(bits[17].data) + parseInt(bits[20].data) +
        parseInt(bits[21].data) + parseInt(bits[24].data) + parseInt(bits[25].data) +
      ...
      var c1 = this.parity(
        ...
        parseInt(bits[15].data) + parseInt(bits[17].data) + parseInt(bits[19].data) +
        parseInt(bits[21].data) + parseInt(bits[23].data) + parseInt(bits[25].data) +
      ...
      return [
        ...
        parseInt(bits[16].data),
        parseInt(bits[17].data),
        parseInt(bits[18].data),
        parseInt(bits[19].data),
        parseInt(bits[20].data),
        parseInt(bits[21].data),
        parseInt(bits[22].data),
        parseInt(bits[23].data),
        parseInt(bits[24].data),
        parseInt(bits[25].data),
        c32,
        parseInt(bits[26].data),
        parseInt(bits[27].data),
        parseInt(bits[28].data),
        parseInt(bits[29].data),
        parseInt(bits[30].data),
